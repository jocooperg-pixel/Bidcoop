          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="text-[10px] text-brand-100 font-medium">6 Destinatarios RM</div>
              </div>
            </div>
            <span className="bg-white/20 text-white font-black text-[10px] px-2 py-1 rounded-full backdrop-blur-md border border-white/20 shrink-0">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="text-[10px] text-teal-100 font-medium">6 Destinatarios IV-X</div>
              </div>
            </div>
            <span className="bg-white/20 text-white font-black text-[10px] px-2 py-1 rounded-full backdrop-blur-md border border-white/20 shrink-0">
            ...
            <div className="p-6 overflow-y-auto space-y-6 text-xs bg-slate-50 dark:bg-slate-950 flex-1">
              ...
              <div className="bg-white text-slate-900 rounded-2xl p-6 border border-slate-200 shadow-md space-y-4 max-h-[600px] overflow-y-auto">
                <div className="border-b border-slate-200 pb-3 space-y-2 text-xs">
                  ...
                  <div><strong>Para Aminorte & V-MOCCS (Sur-Centro):</strong> <span className="font-mono text-slate-700">mviguera@aminorte.cl, lizgamarra@aminorte.cl, jonathan.cooper.g@gmail.com, efarias@aminorte.cl, domfuentes@aminorte.cl, fsantander@vmoccs.cl</span></div>
                  <div><strong>Para Aminorte & V-MOCCS (RM Santiago):</strong> <span className="font-mono text-slate-700">mviguera@aminorte.cl, lizgamarra@aminorte.cl, jonathan.cooper.g@gmail.com, efarias@aminorte.cl, domfuentes@aminorte.cl, fsantander@vmoccs.cl</span></div>
